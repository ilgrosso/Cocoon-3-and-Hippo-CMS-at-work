...
package com.blogspot.chicchiricco.hctdemo.componentsinfo;
...
public interface GeneralListInfo  {
    ...
    @Parameter(name = "docType", defaultValue="hctdemo:basedocument", displayName = "Document Type", typeHint = ComponentWrapper.ParameterType.STRING)
    String getDocType();
